...
class OreoNotification(base: Context?) : ContextWrapper(base) {
    ...
    companion object {
        private const val CHANNEL_ID = "com.devrakan.rshop"
        private const val CHANNLE_NAME = "rShop"
    }
    ...
    private fun createChannel() {
        val channel =
            NotificationChannel(CHANNEL_ID, CHANNLE_NAME, NotificationManager.IMPORTANCE_DEFAULT)
